  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-md p-4 space-y-8 sm:p-8">
            ...
            <div className="w-full max-w-sm space-y-4">
              ...
              <form onSubmit={handleEmailAuth} className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  />
                  {passwordError && (
                    <p className="px-1 text-sm text-red-500">{passwordError}</p>
                  )}
                </div>
                <button
                  type="submit"
                  disabled={isLoading || !email || !password || !!passwordError}
                  className="relative w-full px-4 py-3 text-sm font-medium transition-all rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed auth-button"
                >
                  {isLoading
                    ? isSignUp
                      ? "Creating account..."
